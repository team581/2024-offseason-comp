  ...
  public static Translation2d noteIdToTranslation(int noteId) {
    switch (noteId) {
      ...
      case 3:
        ...
        // TODO: SUBTRACT 5 METER FROM X TO PUT INTO NORMAL FIELD POSES
      case 4:
        return new Translation2d(13.271, 7.458);
      case 5:
        return new Translation2d(13.271, 5.782);
      case 6:
        return new Translation2d(13.271, 4.106);
      case 7:
        return new Translation2d(13.271, 2.429);
      case 8:
        return new Translation2d(13.271, 0.753);
      default:
